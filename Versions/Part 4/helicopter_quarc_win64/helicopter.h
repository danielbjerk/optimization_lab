...
struct P_helicopter_T_ {
  ...
  real_T Vd_ff;                        /* Variable: Vd_ff
                                        * Referenced by: '<Root>/Vd_bias1'
                                        */
  real_T Vs_ff;                        /* Variable: Vs_ff
                                        * Referenced by: '<Root>/Vs_bias1'
                                        */
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T elavation_offsetdeg1_Value;   /* Expression: -30
 ...
 *
 * '<Root>' : 'helicopter'
 * '<S1>'   : 'helicopter/Conversion1'
 * '<S2>'   : 'helicopter/Degrees to Radians1'
 * '<S3>'   : 'helicopter/Elevation controller1'
 * '<S4>'   : 'helicopter/Helicopter_interface'
 * '<S5>'   : 'helicopter/Pitch controller1'
 * '<S6>'   : 'helicopter/Elevation controller1/If Action Subsystem'
